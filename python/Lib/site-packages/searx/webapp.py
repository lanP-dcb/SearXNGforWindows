...
# Add the parent directory to sys.path so the searx package can be found
# when this file is launched directly (e.g. ``python searx/webapp.py``).
...
from searx.version import VERSION_STRING, VERSION_TAG, GIT_URL, GIT_BRANCH
